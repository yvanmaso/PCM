...
Model: it is an instance of Meta-model. In our project it represents the different packages for example org.diverse.PCM.io.Wikipedia.<br>

Project:
The project contains different packages:
* org.diverse.PCM.api.java: This package contains the different interfaces of our PCM project. It is basing on the Meta-model. 
...
# System Functionalities
 ...
 The Visitor design pattern is used in that project.
 ...
 Classes in Wikipedia follow the closed principle in Object-Oriented programming. 
